    ...
    const fetchBrief = async () => {
      ...
      if (activeDeals.length > 0) {
        ...
        if (isMounted) {
          ...
          if (data && data.priorities.length > 0 && !data.priorities[0].includes('quota') && !data.priorities[0].includes('Check internet') && !data.priorities[0].includes('Configure API Key')) {
